...
const dicts: Record<Lang, Dict> = {
  en: {
    ...
    'dialog.addUrl.urlInvalid': 'Please enter a valid http(s) URL',
    'dialog.addUrl.category': 'Category',
    'dialog.addUrl.size': 'Size',
    'dialog.addUrl.savePath': 'Save to',
    'dialog.addUrl.fileName': 'File name',
    'dialog.addUrl.paste': 'Paste from clipboard',
    'dialog.addUrl.threads': 'Threads',
  ...
  'zh-CN': {
    ...
    'status.total': '总计',
    // Dialogs
    'dialog.addUrl.title': '添加下载',
    'dialog.addUrl.url': '链接',
    'dialog.addUrl.urlPlaceholder': 'https://example.com/file.zip',
    'dialog.addUrl.urlInvalid': '请输入有效的 http(s) 链接',
    'dialog.addUrl.category': '类别',
    'dialog.addUrl.size': '大小',
    'dialog.addUrl.savePath': '保存到',
    'dialog.addUrl.fileName': '文件名',
    'dialog.addUrl.paste': '从剪贴板粘贴',
    'dialog.addUrl.threads': '线程数',
